...
export async function registerAppRoutes(app: Express): Promise<void> {
  ...
  app.patch("/api/bookings/:id/change-seat", async (req, res) => {
    try {
      const { id } = req.params;
  ...
  app.post("/api/bookings/payment-method", sensitiveOperationLimiter, async (req, res) => {
    try {
  ...
  app.post("/api/bookings/payment-status", sensitiveOperationLimiter, async (req, res) => {
    try {
  ...
  app.post("/api/bookings/split-payment", sensitiveOperationLimiter, async (req, res) => {
    try {
  ...
  app.get("/api/reports/retention-metrics", async (req, res) => {
    try {
  ...
  app.get("/api/happy-hours-config", async (req, res) => {
    try {
  ...
  app.post("/api/happy-hours-config", async (req, res) => {
    try {
      const { category, configs } = req.body;
      if (!category || !Array.isArray(configs)) {
        return res.status(400).json({ message: "Invalid request format" });
  ...
  app.delete("/api/happy-hours-config/:category", async (req, res) => {
    try {
      const { category } = req.params;
  ...
  app.get("/api/happy-hours-pricing", async (req, res) => {
    try {
  ...
  app.post("/api/happy-hours-pricing", async (req, res) => {
    try {
      const { category, configs } = req.body;
      if (!category || !Array.isArray(configs)) {
        return res.status(400).json({ message: "Invalid request format" });
  ...
  app.delete("/api/happy-hours-pricing/:category", async (req, res) => {
    try {
      const { category } = req.params;
  ...
  app.post("/api/food-items/:id/adjust-stock", async (req, res) => {
    try {
      const { id } = req.params;
  ...
  app.get("/api/food-items/low-stock", async (req, res) => {
    try {
  ...
  app.get("/api/food-items/inventory", async (req, res) => {
    try {
  ...
  app.post("/api/food-items/:id/add-to-inventory", async (req, res) => {
    try {
      const { id } = req.params;
  ...
  app.post("/api/food-items/:id/remove-from-inventory", async (req, res) => {
    try {
      const { id } = req.params;
  ...
  app.get("/api/food-items/reorder-list", async (req, res) => {
    try {
  ...
  app.get("/api/stock-batches/:foodItemId", async (req, res) => {
    try {
  ...
  app.get("/api/ai/maintenance/predictions", async (req, res) => {
    try {
  ...
  app.get("/api/ai/traffic/predictions", async (req, res) => {
    try {
  ...
  app.put("/api/maintenance/:category/:seatName/status", async (req, res) => {
    try {
  ...
  app.post("/api/maintenance/:category/:seatName/report-issue", async (req, res) => {
    try {
      const { category, seatName } = req.params;
  ...
  app.get("/api/customer/:whatsappNumber/active-bookings", async (req, res) => {
    try {
